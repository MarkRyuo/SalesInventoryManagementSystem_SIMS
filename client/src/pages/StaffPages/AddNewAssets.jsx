    ...
    return (
        <Container fluid className="p-0">
            ...
            <Container fluid='md' className="mt-4">
                ...
                <div style={{ width: "auto", height: "auto", padding: 0, display: 'flex', justifyContent: 'center', marginTop: 100, flexDirection: 'column' }}>
                    <div style={{ height: "600px", padding: 20, textAlign: 'center' }}>
