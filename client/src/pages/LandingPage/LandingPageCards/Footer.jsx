            ...
            <Container className="text-center text-md-start mt-5">
                <Row className="mt-3">
                    ...
                    <Col md={3} lg={2} xl={2} className="mb-4">
                        ...
                        <Nav className="flex-column">
                            <Nav.Link href="#!" className="text-reset p-0">Terms and Condition</Nav.Link>
                    ...
                    <Col md={4} lg={3} xl={3} className="mb-4">
                        ...
                        <p><FaShoppingCart className='me-2'/><a className='m-0 p-0 text-reset' href='https://shopee.ph/reyeselectronics?fbclid=IwY2xjawGoJaBleHRuA2FlbQIxMAABHZeteTkZfvcjrqobcCIOnhtALf9tnpL5EavTI-F-2Sj_GJkM7gmpJOgyeg_aem_6fnRuc25GZqBjftFPAuF5Q' style={{textDecoration: 'none'}}>Our Online Shop</a></p>
